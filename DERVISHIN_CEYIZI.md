...
```python
# Emare Bot — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    'Emarebot.view',      # Görüntüleme
    'Emarebot.create',    # Oluşturma
    'Emarebot.edit',      # Düzenleme
    'Emarebot.delete',    # Silme
    'Emarebot.manage',    # Tam yönetim
    # Admin
    'Emarebot.admin',     # Admin panele erişim
    'Emarebot.users',     # Kullanıcı yönetimi
    'Emarebot.settings',  # Ayar yönetimi
]
```
...
```python
# Emarebot/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        'Emarebot.view', 'Emarebot.create',
        'Emarebot.edit', 'Emarebot.delete',
        'Emarebot.manage', 'Emarebot.users',
        'Emarebot.settings', 'Emarebot.admin',
    },
    'operator': {
        'Emarebot.view', 'Emarebot.create',
        'Emarebot.edit',
...
| Proje Admini | admin@Emarebot.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@Emarebot.emare.dev | super_admin | Machine-to-machine |
