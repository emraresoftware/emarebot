# Emare Bot — Hızlı Başlangıç (Developer Guide)
...
```bash
# Repo'ya gir
cd /Users/emre/Desktop/Emare/Emarebot
...
| 6 | `Emarebot_HAFIZA.md` | Proje geçmişi |
...
- **Derviş**: EmareAPI'de `Emarebot Dervishi` bu projeden sorumlu
